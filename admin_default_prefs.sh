...
/usr/local/sbin/dockutil --remove all
/usr/local/sbin/dockutil --add /Applications/Utilities/System\ Information.app
/usr/local/sbin/dockutil --add /Applications/Safari.app
/usr/local/sbin/dockutil --add /Applications/Utilities/Terminal.app
/usr/local/sbin/dockutil --add /Applications/Utilities/Console.app
/usr/local/sbin/dockutil --add /Applications/Utilities/Activity\ Monitor.app
/usr/local/sbin/dockutil --add /Applications/Utilities/Directory\ Utility.app
/usr/local/sbin/dockutil --add /Applications/Utilities/Network\ Utility.app
/usr/local/sbin/dockutil --add /Applications/Utilities/Airport\ Utility.app
/usr/local/sbin/dockutil --add /Applications/Utilities/Wireless\ Diagnostics.app
/usr/local/sbin/dockutil --add /Applications/Utilities/Disk\ Utility.app
/usr/local/sbin/dockutil --add /Applications/Utilities/Keychain\ Access.app
/usr/local/sbin/dockutil --add /Applications/Time\ Machine.app
